...
<body>
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="#"> UPARK - Lot Details </a>
			</div>
		</div>
	</nav>
	...
	<div class ="container">
		...
		<h1 align="center">
			<font color="white">University of Utah Lot(s)</font>
		</h1>
		<div class="panel panel-default">
	  <div class="panel-heading">
	  	<div class="panel-title pull-left">Union Parking Lot</div>
	  	...
	  	<div class="clearfix"></div>
			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="col-md-8">Available Parking Spots</div>
					<div class="col-md-2"><h3>12</h3></div>
					<div class="col-md-2"><svg width="37px" height="37px" viewBox="0 0 37 37" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <g id="Mobile" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-dasharray="80">
        <g id="Add-Locations" transform="translate(-295.000000, -171.000000)" stroke="#FF1400" stroke-width="4">
            <path d="M313.5,173 L313.5,173 C322.612698,173 330,180.387302 330,189.5 L330,189.5 C330,198.612698 322.612698,206 313.5,206 L313.5,206 C304.387302,206 297,198.612698 297,189.5 L297,189.5 C297,180.387302 304.387302,173 313.5,173 Z" id="Rectangle-3-Copy"></path>
				...
				<div class="row">
					...
					<div class="col-md-8">201 Presidents Cir, Salt Lake City, UT</div>
		...
		<table id="lotInformation">
			<tr>
				<th>Union Building Parking Lot</th>
				<th></th>
				<th>
    ...
    <g id="Mobile" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-dasharray="80">
		...
		<table id="lotInformation">
			<tr>
				<th>Merrill Engineering Building Parking</th>
				<th></th>
				<th>
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
    			<path d="M0 0h24v24H0z" fill="none" />
